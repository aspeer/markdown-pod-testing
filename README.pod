...
L<Markdent|http://search.cpan.org/dist/Markdent/> 0.25

L<Markdown::Pod|???> 0.005 + patches from https://github.com/aspeer/Markdown-Pod
...
These are corner cases - for most simple Docbook documents the pipeline works well as a formatter. As an exampled this README was produced in L<XMLMind XML Editor|???> using a Docbook 5.0 Section Template and exported to markdown and POD using the above pipeline.
